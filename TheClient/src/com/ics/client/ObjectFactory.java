 ...
 * generated in the com.ics.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValue_QNAME = new QName("http://service.ics.com/", "getValue");
    private final static QName _GetValueResponse_QNAME = new QName("http://service.ics.com/", "getValueResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ics.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ics.com/", name = "getValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ics.com/", name = "getValueResponse")
