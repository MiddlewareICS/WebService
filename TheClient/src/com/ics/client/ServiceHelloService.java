 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://service.ics.com/", wsdlLocation = "http://localhost:9001/Service/ServiceHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEHELLOSERVICE_QNAME = new QName("http://service.ics.com/", "ServiceHelloService");
    ...
    public ServiceHello getServiceHelloPort() {
        return super.getPort(new QName("http://service.ics.com/", "ServiceHelloPort"), ServiceHello.class);
    }
    ...
    public ServiceHello getServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ics.com/", "ServiceHelloPort"), ServiceHello.class, features);
    }
